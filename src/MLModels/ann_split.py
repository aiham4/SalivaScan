...
class AnnSplitModel(NNBase):
    ...
    def export(self, X, y):
        ...
        for train_idx, val_idx in skf.split(X, y):
            ...
            X_train_val, X_test = X[train_idx], X[val_idx]
            y_train_val, y_test = y[train_idx], y[val_idx]
            
            reducer = self.train(model, X_train_val, y_train_val)
